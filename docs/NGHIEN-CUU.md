...
- **[TÁI DỰNG]** Bản hiện tại có vị trí đậu thật, gọi về và phòng thủ theo từng
  ...
  `TACH_HAM_GALANA`) và quy tắc hai đội giữ nguyên giờ đi/giờ tới của đội gốc — tính lại
  theo tốc độ đội mới sẽ biến "gửi kèm Tàu Dầu rồi tách giữa đường" thành mẹo rút ngắn
  chuyến bay, nên bản này không tính lại.
...
| Ngân hàng, siêu thị do người chơi nhập hàng, chợ tự do có thuế/giao chậm | **Phần lớn đã có:** ngân hàng cho gửi lấy lãi **2%/ngày** cộng ở checkpoint bảo trì, cộng khoản đầu tư khoá kỳ không rút giữa chừng; siêu thị có **kho hữu hạn** và **quỹ tiền mặt** nên bán quá tay là nó hết tiền — đúng tình huống khủng hoảng nhiên liệu mà tư liệu kể — lấy **thuế 10%** và **giao hàng sau 6 giờ**. **[TÁI DỰNG]** cách chia lãi theo checkpoint, quy tắc không trả lãi khi lỡ bảo trì, và mức trần kho/quỹ neo theo dung tích kho của đế quốc (đoàn buôn NPC bù dần) — vì bản một người không có người chơi khác nhập hàng. **Chưa có:** chợ tự do người-với-người thuế 5%, và một siêu thị DÙNG CHUNG do người chơi nhập hàng ở bản nhiều người (cần bảng riêng trong SQLite). |
