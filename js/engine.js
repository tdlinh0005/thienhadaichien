...
G.STATE_VERSION = 7;   // v7 kinh tế thật (nâng cấp tuần tự nằm ở js/migration.js)
...
/* G.nangCapState đã chuyển sang js/migration.js (tách theo review hội đồng);
 * engine chỉ giữ G.STATE_VERSION. migration.js được nạp trước engine
 * (thứ tự trong tools/source-manifest.js: combat -> migration -> engine). */
